 ...
 * god(false), creroll(), creroll(10), creroll(false), traceend(),
...
setImmediate(() => {
    log("ready: revive(), reroll(96), creroll(), creroll(n), creroll(false), inc(n), heal(percent), read(), god(), god(seconds), god(false), traceend(), traceend(false), traceendstatus(); automatic reroll(96) scheduled");
