...
/*
 * Commands: revive(), reroll(96), inc(100), read().
...
// Four REPL shortcuts and four corresponding RPC entry points only.
...
setImmediate(() => {
    log("ready: revive(), reroll(96), inc(n), read(); automatic reroll(96) scheduled");
