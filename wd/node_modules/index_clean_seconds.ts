...
/*
 * Commands: revive(), reroll(96), inc(100), read(), god(), god(5), god(false).
...
setImmediate(() => {
    log("ready: revive(), reroll(96), inc(n), read(), god(), god(seconds), god(false); automatic reroll(96) scheduled");
