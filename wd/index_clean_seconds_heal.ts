...
/*
 * Commands: revive(), reroll(96), inc(100), heal(50), read(), god(), god(5), god(false).
...
setImmediate(() => {
    log("ready: revive(), reroll(96), inc(n), heal(percent), read(), god(), god(seconds), god(false); automatic reroll(96) scheduled");
